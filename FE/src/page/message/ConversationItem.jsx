  ...
  return (
    <>
      <div
        ...
        onClick={onClick}
      >
        <img src={user.avatar} alt="" className="w-13 h-13 rounded-full object-cover shrink-0" />
        ...
        <div className="flex flex-col gap-1 min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2 text-xs text-white/60 min-w-0 justify-between">
            <p className="truncate flex-1">
              {user.lastMessage
                ? (user.lastMessage.sender === currentUser?._id || user.lastMessage.sender?._id === currentUser?._id
